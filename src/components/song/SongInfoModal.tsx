...
const SongInfoModal: React.FC<ISongInfoModal> = ({ 
  ...
  return (
    ...
    >
      <div className="fixed inset-0 flex-col bg-[#2b2b2b] flex md:hidden w-full h-full info-modal">
        <div className="flex flex-row h-full relative">
          <div className="flex-1 text-white flex flex-col justify-center items-center p-8">
            <button onClick={onClose} className="absolute top-4 left-4 text-gray-300 p-2">
